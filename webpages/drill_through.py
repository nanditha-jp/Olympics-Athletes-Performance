...
def show():
    ...
    with col1:
        ...
        df_athletes = analysis.athlete_wise_medal_distribution({}, top_n=10)
    ...
    with col2:
        ...
        df_countries = analysis.country_wise_medal_distribution({}, top_n=10)
    ...
    fig = plot.plot_age_distribution_across_sports({})
    st.plotly_chart(fig, use_container_width=True)

    st.markdown("### 📈 Participation Trends Over the Years")
    fig = plot.plot_participation_trend_over_time({})
    st.plotly_chart(fig, use_container_width=True)
